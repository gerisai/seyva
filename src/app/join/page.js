...
export default function Home() {
  ...
  return (
    <main className="h-auto flex items-center justify-center flex-col bg-gray text-black">
      <div className="flex flex-col items-center gap-12 py-12 w-3/4 justify-center text-center">
        <h1 className="xs:text-4xl md:text-5xl font-bold text-gray">¡Realiza tu donativo aquí!</h1>
        <p className="text-xl">
        ...
        <h1 className="xs:text-4xl md:text-5xl font-bold text-gray">Súmate a la causa</h1>
